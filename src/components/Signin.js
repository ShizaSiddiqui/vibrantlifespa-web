...
const SignIn = ({ setClientId, onClose }) => {
  ...
  const handleSignIn = async () => {
    try {
      ...
      let otpResponse;
      if (isMobile) {
        otpResponse = await axios.post('https://api.vibrantlifespa.com:8001/sendOTPforLoginViaNumber', {
          mobilePhone: inputValue,
        });
      } else {
        otpResponse = await axios.post('https://api.vibrantlifespa.com:8001/sendOTPforLoginViaEmail', {
          email: inputValue,
        });
      }
  ...
  const handleVerifyOtp = async () => {
    try {
      ...
      const cartResponse = await axios.post('https://api.vibrantlifespa.com:8001/createCartforUser', {
      ...
      const verifyResponse = await axios.post('https://api.vibrantlifespa.com:8001/verifyLoginUsingOTP', {
      ...
      if (isMobile) {
        clientInfoResponse = await axios.post('https://api.vibrantlifespa.com:8001/getClientInfoViaNumber', {
          mobilePhone: inputValue
        });
      } else {
        clientInfoResponse = await axios.post('https://api.vibrantlifespa.com:8001/getClientInfo', {
          email: inputValue
        });
      }
